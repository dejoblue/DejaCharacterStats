...
if namespace.locale == "koKR" then
	L["/dcstats config: Open the DejaCharacterStats addon config menu."] = "/dcstats config: DejaCharacterStats 애드온 설정 메뉴를 엽니다."
	...
	L["Avoidance"] = "광역회피"
	L["Bewegungsgeschwindigkeit"] = "이동 속도"
	L["Block"] = "방패 막기"
	...
	L["Displays average item level to two decimal place."] = "평균 아이템 레벨을 소수점 둘째 자리까지 표시합니다."
