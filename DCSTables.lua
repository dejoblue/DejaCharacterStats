...
-----------------------
	...
	DCS_ILvl_EQ_AV_Check:SetScript("OnClick", function(self,event)
...
local DCS_ItemLevelDecimalPlacesCheck = CreateFrame("CheckButton", "DCS_ItemLevelDecimalPlacesCheck", DejaCharacterStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	DCS_ItemLevelDecimalPlacesCheck:SetScript("OnClick", function(self,event)
		local checked = self:GetChecked()
...
local DCS_ItemLevelTwoDecimalsCheck = CreateFrame("CheckButton", "DCS_ItemLevelTwoDecimalsCheck", DejaCharacterStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	DCS_ItemLevelTwoDecimalsCheck:SetScript("OnClick", function(self,event)
		local checked = self:GetChecked()
...
DCS_TableData.StatData.MASTERY_RATING = {
	updateFunc = function(statFrame, unit)
		...
		PaperDollFrame_SetLabelAndText(statFrame, color_rating, dcs_format(color_format,rating), false, rating);
		statFrame.tooltip = HIGHLIGHT_FONT_COLOR_CODE..color_rating.." "..dcs_format(color_format,rating)..add_text..FONT_COLOR_CODE_CLOSE;
